...
$(document).on('click','.editBtn',function(d){
    ...
    //ajax
    $.ajax({
        url : "https://mas-auction.mybluemix.net/items/edit",
        type : "POST",
        dataType :"json",
        data : obj,
...
$("#win-conf-item-btn").click(function (d){
    ...
    if(additemenabled){
        //post req
        var obj = createJSON();
        var path = "https://mas-auction.mybluemix.net/items/add";
        ...
        //post req
        var obj = createJSON();
        var path = "https://mas-auction.mybluemix.net/items/edit/confirm";
...
$("#del-item-cbtn").click(function(d) {
    ...
    var path = "https://mas-auction.mybluemix.net/items/del";
    ...
    $.ajax({
        ...
        type : "DELETE",
        success:function(data,textStatus,jqXHR){
             sendDatatoUpdate({},"https://mas-auction.mybluemix.net/items/initial");
        }
    })
})
